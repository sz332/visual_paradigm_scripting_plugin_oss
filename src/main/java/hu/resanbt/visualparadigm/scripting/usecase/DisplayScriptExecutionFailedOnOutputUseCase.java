...
public class DisplayScriptExecutionFailedOnOutputUseCase implements UseCase {

    private final EventBus eventBus;
    private final JTextArea textArea;

    public DisplayScriptExecutionFailedOnOutputUseCase(EventBus eventBus, JTextArea textArea) {
