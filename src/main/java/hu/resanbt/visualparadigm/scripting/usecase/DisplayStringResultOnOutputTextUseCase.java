...
public class DisplayStringResultOnOutputTextUseCase implements UseCase {

    private final EventBus eventBus;
    private final JTextArea textArea;

    public DisplayStringResultOnOutputTextUseCase(EventBus eventBus, JTextArea textArea) {
